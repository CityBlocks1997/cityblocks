...
function updateDimensionalGrid(videoCount) {
    ...
    if (videoCount === 1) {
        // Solo video - nice big size in fullscreen
        ...
        // 4x4 grid (12 videos) - NOW WITH FULLSCREEN WE HAVE ROOM!
        gridContainer.style.gridTemplateColumns = 'repeat(4, 1fr)';
        gridContainer.style.gridTemplateRows = 'repeat(4, 1fr)';
        gridContainer.style.width = '90vw';  /* Can be larger with true fullscreen */
        gridContainer.style.height = '85vh'; /* More room without browser chrome */
    }
}

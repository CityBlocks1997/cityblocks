...
function createDimensionalOverlay() {
    ...
    gridContainer.style.cssText = `
        display: grid;
        gap: 4px;         /* Minimal gaps = maximum space for videos */
        max-width: 80vw;
        max-height: 75vh;
        overflow: hidden;
    `;
...
function updateDimensionalGrid(videoCount) {
    ...
    if (videoCount === 1) {
        ...
        gridContainer.style.width = '35vw';
        ...
        // 4x4 grid (12 videos) - SUPER SMALL TO FIT ALL 12
        gridContainer.style.gridTemplateColumns = 'repeat(4, 1fr)';
        gridContainer.style.gridTemplateRows = 'repeat(4, 1fr)';
        gridContainer.style.width = '60vw';  /* Reduced further */
        gridContainer.style.height = '48vh'; /* CRITICAL: Much shorter to fit all 4 rows */
    }
}

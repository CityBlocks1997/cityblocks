...
function updateDimensionalGrid(videoCount) {
    ...
    if (videoCount === 1) {
        ...
        // 4x4 grid (12 videos + 4 empty cells) - REDUCED SIZE TO FIT ALL VIDEOS
        gridContainer.style.gridTemplateColumns = 'repeat(4, 1fr)';
        gridContainer.style.gridTemplateRows = 'repeat(4, 1fr)';
        gridContainer.style.width = '85vw'; /* Reduced from 95vw */
        gridContainer.style.height = '75vh'; /* Reduced from 95vh - leaves room for exit button */
    }
}
